...
export declare const SUPPORTED_DIALECTS: readonly ["mysql", "postgres", "sqlite3", "mariadb", "mssql", "mariadb", "mssql", "db2", "snowflake", "ibmi", "oracle"];
/**
...
export declare abstract class SequelizeTypeScript<Dialect extends AbstractDialect> {
    ...
    static beforeInit: import("./hooks-legacy.js").LegacyAddHookFunction<(options: Options<AbstractDialect>) => void>;
    ...
    beforeDefine: import("./hooks-legacy.js").LegacyAddHookFunction<(attributes: ModelAttributes<any>, options: ModelOptions) => void>;
    afterDefine: import("./hooks-legacy.js").LegacyAddHookFunction<(model: ModelStatic) => void>;
    beforePoolAcquire: import("./hooks-legacy.js").LegacyAddHookFunction<(options?: AcquireConnectionOptions) => AsyncHookReturn>;
    afterPoolAcquire: import("./hooks-legacy.js").LegacyAddHookFunction<(connection: AbstractConnection, options?: AcquireConnectionOptions) => AsyncHookReturn>;
    ...
    beforeSave: import("./hooks-legacy.js").LegacyAddHookFunction<(instance: import("./model").Model<any, any>, options: import("./model").InstanceUpdateOptions<any> | import("./model").CreateOptions<any>) => AsyncHookReturn>;
    afterSave: import("./hooks-legacy.js").LegacyAddHookFunction<(instance: import("./model").Model<any, any>, options: import("./model").InstanceUpdateOptions<any> | import("./model").CreateOptions<any>) => AsyncHookReturn>;
