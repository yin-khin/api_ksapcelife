...
Use Sequelize#query if you wish to use replacements.`);
    ...
    if (!options.type) {
      if (options.model || options.nest || options.plain) {
        options.type = import_enums.QueryTypes.SELECT;
      } else {
...
Sequelize.TableHints = import_enums.TableHints;
Sequelize.IndexHints = import_enums.IndexHints;
Sequelize.Transaction = import_transaction.Transaction;
Sequelize.GeoJsonType = require("./geo-json").GeoJsonType;
Sequelize.prototype.Sequelize = Sequelize;
Sequelize.prototype.QueryTypes = Sequelize.QueryTypes = import_enums.QueryTypes;
...
Sequelize.ParameterStyle = import_enums.ParameterStyle;
